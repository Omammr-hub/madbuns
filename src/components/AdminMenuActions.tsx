      ...
      {isCategoryModalOpen && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 backdrop-blur-sm">
          <div className="bg-[#111] p-8 rounded-3xl w-full max-w-md border border-white/10 shadow-2xl shadow-brand-red/10">
            ...
            <form action={(data) => { addCategory(data); setCategoryModalOpen(false); }}>
              <div className="mb-4">
              ...
              <div className="flex gap-4 mt-8">
                ...
                <button type="submit" className="flex-1 bg-brand-red text-white py-3 rounded-xl font-bold hover:bg-red-700 shadow-lg shadow-brand-red/25 transition-colors">Save</button>
              </div>
            </form>
          </div>
        </div>
      ...
      {isItemModalOpen && (
        <div className="fixed inset-0 bg-black/80 flex items-center justify-center z-50 backdrop-blur-sm">
          <div className="bg-[#111] p-8 rounded-3xl w-full max-w-md border border-white/10 shadow-2xl shadow-brand-red/10">
            ...
            <form action={(data) => { addMenuItem(data); setItemModalOpen(false); }}>
              <div className="mb-4">
